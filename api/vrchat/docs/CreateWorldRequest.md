...
**assetVersion** | **number** |  | [optional] [default to undefined]
...
**id** | **string** | WorldID be \&quot;offline\&quot; on User profiles if you are not friends with that user. | [optional] [default to undefined]
...
```typescript
import { CreateWorldRequest } from './api';

const instance: CreateWorldRequest = {
    assetUrl,
    assetVersion,
    authorId,
    authorName,
